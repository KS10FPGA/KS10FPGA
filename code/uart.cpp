...
//! Initialize the UART
//!
//! This function is executed like a constructor so that the UART is initialize before main() is
//! called.  This guarantees that this function is executed before all others.  This allows all
//! functions called by main() to use UART or STDIO functions.
//!
//! \returns
//!     Nothing
//!
...
void initializeUART(void) {
    ...
    ROM_UARTConfigSetExpClk(UART_BASE, ROM_SysCtlClockGet(), 9600, UART_CONFIG_PAR_NONE |
